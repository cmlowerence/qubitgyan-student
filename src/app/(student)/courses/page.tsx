...
export default function CoursesPage() {
  ...
  const filtered = domains.filter((domain) => domain.name.toLowerCase().includes(query.toLowerCase()));
  ...
  return (
    <div className="space-y-5 pb-10">
      <section className="rounded-3xl bg-white border border-slate-200 p-5 lg:p-7">
        ...
        <p className="text-slate-500 mt-2">Choose your domain and jump into structured, media-rich learning.</p>
